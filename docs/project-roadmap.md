...
**Development status:** post-0.5.0 stabilization at identity 0.6.0; e09 complete; next story approval required
...
epics through e09 are complete with 63 passing tasks; the revision-bound
disposition still covers all 26 July findings; the remaining 9 tasks are
...
explicit next-story approval (recommended: e10s01).
